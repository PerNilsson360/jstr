...
public:
	...
	virtual XpathData eval(const XpathData& d, size_t pos) const = 0;
private:
};
...
public:
  XpathData eval(const XpathData& d, size_t pos) const;
private:
};
...
public:
	...
	XpathData eval(const XpathData& d, size_t pos) const override;
 private:
};
